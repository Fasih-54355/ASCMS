...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div>
        <ul>
        <li><a href="orders.php?action=create">Create New Order</a></li>
        <li><a href="orders.php?action=view">View Orders</a></li>
    </ul>

    <?php
    // Placeholder functionalities
    if ($_GET['action'] === 'create') {
        echo "<p>Create new order form goes here.</p>";
    } elseif ($_GET['action'] === 'view') {
        echo "<p>View orders functionality goes here.</p>";
    }
    ?>
    </div>
